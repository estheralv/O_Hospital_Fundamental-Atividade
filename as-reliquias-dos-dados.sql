...
CREATE database hospital_data IF NOT EXIST;
...
USE hospital_data;
    ...
    (3, 'Fernanda Lima', '1985-03-05', 'Feminino', '9876543210', '87654321098', 'Nenhum', 'Travessa da Paz, 789, Bairro Harmonia, Cidade Serena', '31765432109', 'fernanda.lima@email.com'),
		...
		CREATE TABLE Internaçoes (
			...
			INSERT INTO Internaçoes (InternaçaoID, PacienteID, MedicoID, EnfermeiroID, EnfermeiroID2, Data_da_Internaçao, Hospedagem_Quarto, QuartoID, Descricao_Textual_de_Procedimentos, Data_Prevista_de_Alta, Data_Efetivada_de_Alta) VALUES 
